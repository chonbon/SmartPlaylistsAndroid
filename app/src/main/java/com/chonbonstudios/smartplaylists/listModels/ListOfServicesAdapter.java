package com.chonbonstudios.smartplaylists.listModels;
...
public class ListOfServicesAdapter extends RecyclerView.Adapter<ListOfServicesAdapter.MyViewHolder> {
    ...
    public ListOfServicesAdapter(String[] myDataset) {
        mDataset = myDataset;
    }

    // Create new views (invoked by the layout manager)
    @Override
    public ListOfServicesAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent,
                                                     int viewType) {
        // create a new view
